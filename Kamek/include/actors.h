...
enum Actors {
	...
	AC_LIGHT_WATER = 618,
	AC_COPYRIGHT = 619,
	// Actor 620, in the Nvidia Shield version, is replaced with three new actors.
	// These are unimplemented at the moment, but are worth noting.
	...
	// Note that 702 and 703 are only present in Korean version and later;
	// TIME_UP is 702 in earlier versions and that must be accounted for when using this
